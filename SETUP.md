...
Кодовое слово, необходимое при регистрации, спрашивайте у куратора курса.
...
$ git clone git@gitlab.manytask.org:hsenn/python/students-2026-spring/<твой ник в manytask>
...
$ git remote add upstream git@gitlab.manytask.org:hsenn/python/public-2026-spring.git
```
